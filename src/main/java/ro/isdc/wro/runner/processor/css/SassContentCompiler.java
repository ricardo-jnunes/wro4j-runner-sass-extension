...
public class SassContentCompiler {
	...
	public Output compileContent(String content

	) throws CompilationException {

		Options opt = getConfiguredOptions();

		io.bit3.jsass.Compiler c = new io.bit3.jsass.Compiler();

		return c.compileString(content, opt);
	}

	private Options getConfiguredOptions() {
	 ...
	 */
	public Output compileFile(String inputPathAbsolute, //
